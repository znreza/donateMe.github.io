            ...
            <!-- Collect the nav links, forms, and other content for toggling -->
             <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        <a href="support.php" class="dropdown-toggle" data-toggle="dropdown">Support Us <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li>
                                <a href='#C1'>Volunteery</a>
                            </li>
                            <li>
                                <a href='#C2'>Fund Raising</a>
                            </li>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    <li><a href="support.php">Support Us</a>
                    </li>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
             ...
             <div class="col-md-9">
                <h2 id="C1" href="#1">Volunteery Support</h2>
                <p>If you have ever wanted to bring smile on the face of any human being or creature and raise your hand 
                    towards them, then you have come to the right place. This is not only a page but a medium with a noble 
                    intention to distribute your care and assistance to the needy ones.</p>
            </div>
            ...
            <div class="col-md-9">
                <h2 id="C2" href="#2">Fund Raising</h2>
                <p>If you have ever wanted to bring smile on the face of any human being or creature and raise your hand 
                    towards them, then you have come to the right place. This is not only a page but a medium with a noble 
                    intention to distribute your care and assistance to the needy ones.</p>
            </div>
